...
public class MainActivity extends AppCompatActivity {
    ...
    private void aboutModel() {
        ...
        objMyModel.setOnMyModelChangeListener(new MyModel.OnMyModelChangeListener() {
            @Override
            public void onMyModelChangeListener(MyModel model) {
    ...
    private void changeView(int modelAnInt) {
        ...
        //Change Question
        String strQuestion[] = getResources().getStringArray(R.array.my_question);
        questionTextView.setText(strQuestion[modelAnInt]);
        ...
        //Get String-Array to Variable
        String strChoice[] = getResources().getStringArray(intTimes[modelAnInt]);
